...
static CDataImage x14[] = {
	...
	/* x14[6] */ {  "browseicons",  "browse_icons.png",  IGraphics::CTextureHandle(), },
	/* x14[7] */ {  "console_bg",  "console.png",  IGraphics::CTextureHandle(), },
	/* x14[8] */ {  "console_bar",  "console_bar.png",  IGraphics::CTextureHandle(), },
	/* x14[9] */ {  "speedup_arrow",  "editor/speed_arrow.png",  IGraphics::CTextureHandle(), },
	/* x14[10] */ {  "demobuttons",  "demo_buttons.png",  IGraphics::CTextureHandle(), },
	/* x14[11] */ {  "fileicons",  "file_icons.png",  IGraphics::CTextureHandle(), },
	/* x14[12] */ {  "guibuttons",  "gui_buttons.png",  IGraphics::CTextureHandle(), },
	/* x14[13] */ {  "guiicons",  "gui_icons.png",  IGraphics::CTextureHandle(), },
	/* x14[14] */ {  "arrow",  "arrow.png",  IGraphics::CTextureHandle(), },
	/* x14[15] */ {  "demobuttons2",  "demo_buttons2.png",  IGraphics::CTextureHandle(), },
	/* x14[16] */ {  "audio_source",  "editor/audio_source.png",  IGraphics::CTextureHandle(), },
	/* x14[17] */ {  "strongweak",  "strong_weak.png",  IGraphics::CTextureHandle(), },
};
...
static CDataSprite x44[] = {
	...
	/* x44[92] */ {  "browse_ddnet",  &x28[3],  4,  0,  1,  1, },
	/* x44[93] */ {  "browse_rank",  &x28[3],  5,  0,  1,  1, },
	/* x44[94] */ {  "speedup_arrow",  &x28[5],  0,  0,  1,  1, },
	/* x44[95] */ {  "demobutton_play",  &x28[6],  0,  0,  1,  1, },
	/* x44[96] */ {  "demobutton_pause",  &x28[6],  1,  0,  1,  1, },
	/* x44[97] */ {  "demobutton_stop",  &x28[6],  2,  0,  1,  1, },
	/* x44[98] */ {  "demobutton_slower",  &x28[6],  3,  0,  1,  1, },
	/* x44[99] */ {  "demobutton_faster",  &x28[6],  4,  0,  1,  1, },
	/* x44[100] */ {  "demobutton_slice_begin",  &x28[10],  0,  0,  1,  1, },
	/* x44[101] */ {  "demobutton_slice_end",  &x28[10],  1,  0,  1,  1, },
	/* x44[102] */ {  "demobutton_shortcuts_enabled",  &x28[10],  2,  0,  1,  1, },
	/* x44[103] */ {  "demobutton_shortcuts_disabled",  &x28[10],  3,  0,  1,  1, },
	/* x44[104] */ {  "file_demo1",  &x28[7],  0,  0,  1,  1, },
	/* x44[105] */ {  "file_demo2",  &x28[7],  1,  0,  1,  1, },
	/* x44[106] */ {  "file_folder",  &x28[7],  2,  0,  1,  1, },
	/* x44[107] */ {  "file_map1",  &x28[7],  5,  0,  1,  1, },
	/* x44[108] */ {  "file_map2",  &x28[7],  6,  0,  1,  1, },
	/* x44[109] */ {  "guibutton_off",  &x28[8],  0,  0,  4,  4, },
	/* x44[110] */ {  "guibutton_on",  &x28[8],  4,  0,  4,  4, },
	/* x44[111] */ {  "guibutton_hover",  &x28[8],  8,  0,  4,  4, },
	/* x44[112] */ {  "guiicon_mute",  &x28[9],  0,  0,  4,  2, },
	/* x44[113] */ {  "guiicon_emoticon_mute",  &x28[9],  4,  0,  4,  2, },
	/* x44[114] */ {  "guiicon_friend",  &x28[9],  8,  0,  4,  2, },
	/* x44[115] */ {  "audio_source",  &x28[11],  0,  0,  1,  1, },
	/* x44[116] */ {  "hook_strong",  &x28[12],  0,  0,  1,  1, },
	/* x44[117] */ {  "hook_weak",  &x28[12],  1,  0,  1,  1, },
};
static CAnimKeyframe x4493[] = {
	/* x4493[0] */ {  0.000000f,  0.000000f,  -4.000000f,  0.000000f, },
};
static CAnimKeyframe x4500[] = {
	/* x4500[0] */ {  0.000000f,  0.000000f,  10.000000f,  0.000000f, },
};
static CAnimKeyframe x4507[] = {
	/* x4507[0] */ {  0.000000f,  0.000000f,  10.000000f,  0.000000f, },
};
static CAnimKeyframe *x4514 = 0;
static CAnimKeyframe *x4538 = 0;
static CAnimKeyframe x4545[] = {
	/* x4545[0] */ {  0.000000f,  -7.000000f,  0.000000f,  0.000000f, },
};
static CAnimKeyframe x4552[] = {
	/* x4552[0] */ {  0.000000f,  7.000000f,  0.000000f,  0.000000f, },
};
static CAnimKeyframe *x4559 = 0;
static CAnimKeyframe *x4578 = 0;
static CAnimKeyframe x4585[] = {
	/* x4585[0] */ {  0.000000f,  -3.000000f,  0.000000f,  -0.100000f, },
};
static CAnimKeyframe x4592[] = {
	/* x4592[0] */ {  0.000000f,  3.000000f,  0.000000f,  -0.100000f, },
};
static CAnimKeyframe *x4599 = 0;
static CAnimKeyframe x4618[] = {
	/* x4618[0] */ {  0.000000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x4618[1] */ {  0.200000f,  0.000000f,  -1.000000f,  0.000000f, },
	/* x4618[2] */ {  0.400000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x4618[3] */ {  0.600000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x4618[4] */ {  0.800000f,  0.000000f,  -1.000000f,  0.000000f, },
	/* x4618[5] */ {  1.000000f,  0.000000f,  0.000000f,  0.000000f, },
};
static CAnimKeyframe x4625[] = {
	/* x4625[0] */ {  0.000000f,  8.000000f,  0.000000f,  0.000000f, },
	/* x4625[1] */ {  0.200000f,  -8.000000f,  0.000000f,  0.000000f, },
	/* x4625[2] */ {  0.400000f,  -10.000000f,  -4.000000f,  0.200000f, },
	/* x4625[3] */ {  0.600000f,  -8.000000f,  -8.000000f,  0.300000f, },
	/* x4625[4] */ {  0.800000f,  4.000000f,  -4.000000f,  -0.200000f, },
	/* x4625[5] */ {  1.000000f,  8.000000f,  0.000000f,  0.000000f, },
};
static CAnimKeyframe x4632[] = {
	/* x4632[0] */ {  0.000000f,  -10.000000f,  -4.000000f,  0.200000f, },
	/* x4632[1] */ {  0.200000f,  -8.000000f,  -8.000000f,  0.300000f, },
	/* x4632[2] */ {  0.400000f,  4.000000f,  -4.000000f,  -0.200000f, },
	/* x4632[3] */ {  0.600000f,  8.000000f,  0.000000f,  0.000000f, },
	/* x4632[4] */ {  0.800000f,  8.000000f,  0.000000f,  0.000000f, },
	/* x4632[5] */ {  1.000000f,  -10.000000f,  -4.000000f,  0.200000f, },
};
static CAnimKeyframe *x4639 = 0;
static CAnimKeyframe *x4738 = 0;
static CAnimKeyframe *x4745 = 0;
static CAnimKeyframe *x4752 = 0;
static CAnimKeyframe x4759[] = {
	/* x4759[0] */ {  0.000000f,  0.000000f,  0.000000f,  -0.100000f, },
	/* x4759[1] */ {  0.300000f,  0.000000f,  0.000000f,  0.250000f, },
	/* x4759[2] */ {  0.400000f,  0.000000f,  0.000000f,  0.300000f, },
	/* x4759[3] */ {  0.500000f,  0.000000f,  0.000000f,  0.250000f, },
	/* x4759[4] */ {  1.000000f,  0.000000f,  0.000000f,  -0.100000f, },
};
static CAnimKeyframe *x4793 = 0;
static CAnimKeyframe *x4800 = 0;
static CAnimKeyframe *x4807 = 0;
static CAnimKeyframe x4814[] = {
	/* x4814[0] */ {  0.000000f,  0.000000f,  0.000000f,  -0.250000f, },
	/* x4814[1] */ {  0.100000f,  0.000000f,  0.000000f,  -0.050000f, },
	/* x4814[2] */ {  0.150000f,  0.000000f,  0.000000f,  0.350000f, },
	/* x4814[3] */ {  0.420000f,  0.000000f,  0.000000f,  0.400000f, },
	/* x4814[4] */ {  0.500000f,  0.000000f,  0.000000f,  0.350000f, },
	/* x4814[5] */ {  1.000000f,  0.000000f,  0.000000f,  -0.250000f, },
};
static CAnimation x75[] = {
	/* x75[0] */ {  "base",  /* x75[0].body */ {  1,x4493, },  /* x75[0].back_foot */ {  1,x4500, },  /* x75[0].front_foot */ {  1,x4507, },  /* x75[0].attach */ {  0,x4514, }, },
	/* x75[1] */ {  "idle",  /* x75[1].body */ {  0,x4538, },  /* x75[1].back_foot */ {  1,x4545, },  /* x75[1].front_foot */ {  1,x4552, },  /* x75[1].attach */ {  0,x4559, }, },
	/* x75[2] */ {  "inair",  /* x75[2].body */ {  0,x4578, },  /* x75[2].back_foot */ {  1,x4585, },  /* x75[2].front_foot */ {  1,x4592, },  /* x75[2].attach */ {  0,x4599, }, },
	/* x75[3] */ {  "walk",  /* x75[3].body */ {  6,x4618, },  /* x75[3].back_foot */ {  6,x4625, },  /* x75[3].front_foot */ {  6,x4632, },  /* x75[3].attach */ {  0,x4639, }, },
	/* x75[4] */ {  "hammer_swing",  /* x75[4].body */ {  0,x4738, },  /* x75[4].back_foot */ {  0,x4745, },  /* x75[4].front_foot */ {  0,x4752, },  /* x75[4].attach */ {  5,x4759, }, },
	/* x75[5] */ {  "ninja_swing",  /* x75[5].body */ {  0,x4793, },  /* x75[5].back_foot */ {  0,x4800, },  /* x75[5].front_foot */ {  0,x4807, },  /* x75[5].attach */ {  6,x4814, }, },
};
static CDataSprite* *x4971 = 0;
static CDataSprite* x5108[] = {
	&x44[29],
	&x44[30],
	&x44[31],
};
static CDataSprite* x5293[] = {
	&x44[35],
	&x44[36],
	&x44[37],
};
static CDataSprite* *x5478 = 0;
static CDataSprite* *x5615 = 0;
static CDataSprite* x5752[] = {
	&x44[52],
	&x44[53],
	&x44[54],
};
static CDataWeaponspec x1887[] = {
	/* x1887[0] */ {  "hammer",  &x44[41],  &x44[42],  &x44[43],  0,x4971,  96,  125,  10,  0,  3,  4.000000f,  -20.000000f,  0.000000f,  0.000000f,  5.000000f, },
	/* x1887[1] */ {  "gun",  &x44[26],  &x44[27],  &x44[28],  3,x5108,  64,  125,  10,  500,  1,  32.000000f,  4.000000f,  58.875200f,  6.000000f,  5.000000f, },
	/* x1887[2] */ {  "shotgun",  &x44[32],  &x44[33],  &x44[34],  3,x5293,  96,  500,  10,  0,  1,  24.000000f,  -2.000000f,  83.312800f,  6.000000f,  5.000000f, },
	/* x1887[3] */ {  "grenade",  &x44[38],  &x44[39],  &x44[40],  0,x5478,  96,  500,  10,  0,  1,  24.000000f,  -2.000000f,  0.000000f,  0.000000f,  5.000000f, },
	/* x1887[4] */ {  "laser",  &x44[47],  &x44[48],  &x44[49],  0,x5615,  92,  800,  10,  0,  5,  24.000000f,  -2.000000f,  0.000000f,  0.000000f,  5.000000f, },
	/* x1887[5] */ {  "ninja",  &x44[44],  &x44[45],  &x44[46],  3,x5752,  96,  800,  10,  0,  9,  0.000000f,  0.000000f,  40.000000f,  -4.000000f,  5.000000f, },
};
